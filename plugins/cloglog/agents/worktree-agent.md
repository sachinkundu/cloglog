...
4. Call `mcp__cloglog__report_artifact(plan_task_id, worktree_id, plan_file_path)` with the repo-relative path to the plan file — without this, the pipeline guard blocks the downstream impl task
