...
from `plugins/cloglog/docs/agent-lifecycle.md` §2 and §5 — the same tier-1 →
...
else). See `plugins/cloglog/docs/agent-lifecycle.md` §5 for the unified-flow spec.
...
3. **Every assigned task is resolved from the agent's side.** This is
   the project completion contract from `plugins/cloglog/docs/agent-lifecycle.md`
